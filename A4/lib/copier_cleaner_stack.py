...
class CopierCleanerStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        # Create an IAM policy statement for CloudWatch permissions
        ...
        # Create an IAM policy statement for S3 permissions
        ...
        # Add the policy statements to the logger lambda's role
        logger_lambda.add_to_role_policy(cloudwatch_policy_statement)
        logger_lambda.add_to_role_policy(s3_policy_statement)
